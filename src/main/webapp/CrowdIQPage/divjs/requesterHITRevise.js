...
require([], function () {
    ...
    $.getJSON("../divjson/requesterHITRevise.json").then(
        function (data) {
            var task = data;
            ...
            $("#worker-number").append("<td><p contenteditable='true'>"+worker_number+"</td>");
            $("#each-reward").append("<td><p contenteditable='true'>"+each_reward+"</td>");
            $("#deadline").append("<td><p contenteditable='true'>"+deadline+"</td>");
